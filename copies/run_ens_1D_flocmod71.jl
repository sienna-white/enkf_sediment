...
dz = H/N # grid spacing - may need to adjust to reduce oscillations
 ...
 #********************** SPATIAL DOMAIN  ***************************
 dt = 0.2 #0.02 #0.5 #0.5    # (seconds) size of time step 
#  M = 360000 * 6360036 #8 #0*5 #*8 #0 #* 3 # 5 #12 #0 * 12 #100*60*3 #0 # 864000 
    #72000 #0 #*2
 M = 36000*6 #2 #0/2 #4320000 # 360000 # for 0.03
 # Increments for saving profiles. set to 1 to save all; 10 saves every 10th, etc. 
 isave = 100 #30 #6000 #*2 #1200 #0 #2400  
 var2save = ["G", "Kz", "U"]
...
create_output_dict(M, isave, var2save, N)
 ...
 Ns = 40 #36 #40                 # Number of sediment size classes

ssc = zeros(Nens, N, Ns)
ssc[:,:,15]  .= 5e12 
ssc[:,:,25] .= 5e10  # Matrix for sediment concentration (N x Ns)
